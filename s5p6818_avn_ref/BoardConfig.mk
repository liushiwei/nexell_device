TARGET_BOARD_INFO_FILE := device/nexell/s5p6818_avn_ref/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := s5p6818_avn_ref
...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/s5p6818_avn_ref/recovery.fstab

TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/s5p6818_avn_ref
TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_s5p6818_avn_ref
...
# certificate
#PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/nexell/security/s5p6818_avn_ref/release

# opengl
BOARD_EGL_CFG := device/nexell/s5p6818_avn_ref/egl.cfg
